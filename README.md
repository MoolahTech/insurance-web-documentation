...
Sandbox
https://insurance.thesavvyapp.in

Production
https://insurance.savvyapp.in
...
| name | type | example |
| ---- | ---- |:-------:|
| partner_transaction_id | string, generated by you, identifies the transaction | XYZ123 |
| product_type | string | "job_loss", "covid" (complete list provided separately) |
| provider | string | "chola", "icici_lomabrd" (complete list provided separately) |
